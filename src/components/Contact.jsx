  ...
  return (
    ...
    >
      ...
      >
        ...
        <button type="submit" className="bg-primary text-white py-2 rounded hover:bg-secondary transition">Send Message</button>
      </form>
      ...
      >
        <a href="https://github.com/shwetasingh888" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-full hover:bg-secondary transition">
